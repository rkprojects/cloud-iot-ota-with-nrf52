...
#ifdef USE_GCP_IOT_CORE

#error "Add certificate paths and IoT Core settings then comment this line."

// Google Cloud IoT Core Settings
// =================================================
#define GCP_IOT_MQTT_HOST           "mqtt.2030.ltsapis.goog"
#define GCP_IOT_MQTT_PORT           8883
//Replace these settings for your GCP Settings.
#define GCP_PROJECT_ID              "your-gcp-project-id"
#define GCP_IOT_DEVICE_ID           "my-device" //based on quickstart tutorial on Cloud IoT core documentation
#define GCP_IOT_REGISTRY_NAME       "my-registry" //based on quickstart tutorial on Cloud IoT core documentation
#define GCP_IOT_LOCATION            "your-registry-region" //Registry Location/Region like: asia-east1

//ROFS paths
#define GCP_IOT_ROOT_CA_FILENAME            ""
#define GCP_IOT_DEVICE_CERTIFICATE_FILENAME ""
#define GCP_IOT_DEVICE_PRIVATE_KEY_FILENAME ""
...
#define MAX_SIZE_OF_UNIQUE_CLIENT_ID_BYTES          128 ///< Maximum size of the Unique Client Id. For More info on the Client Id refer \ref response "Acknowledgments"
...
#define AWS_IOT_MQTT_CLIENT_ID          "MyIotThing" ///< MQTT client ID should be unique for every device
#define AWS_IOT_MY_THING_NAME           "MyIotThing" ///< Thing Name of the Shadow this device is associated with

//ROFS paths
#define AWS_IOT_ROOT_CA_FILENAME            "" ///< Root CA file name
#define AWS_IOT_DEVICE_CERTIFICATE_FILENAME "" ///< device signed certificate file name
#define AWS_IOT_DEVICE_PRIVATE_KEY_FILENAME "" ///< Device private key filename
// =================================================
