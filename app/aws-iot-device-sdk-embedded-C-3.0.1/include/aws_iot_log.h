...
#define IOT_DEBUG(...)    \
	{\
	dbg_printf(DEBUG_LEVEL_DEBUG, "DEBUG:   %s L#%d \r\n", __func__, __LINE__);  \
	dbg_printf(DEBUG_LEVEL_DEBUG, __VA_ARGS__); \
...
#define IOT_INFO(...)    \
	{\
	dbg_printf(DEBUG_LEVEL_INFO, __VA_ARGS__); \
...
#define IOT_WARN(...)   \
	{ \
	dbg_printf(DEBUG_LEVEL_INFO, "WARN:  %s L#%d \r\n", __func__, __LINE__);  \
	dbg_printf(DEBUG_LEVEL_INFO, __VA_ARGS__); \
	dbg_printf(DEBUG_LEVEL_INFO, "\r\n"); \
	}
#else
...
#define IOT_ERROR(...)  \
	{ \
	dbg_printf(DEBUG_LEVEL_ERROR, "ERROR: %s L#%d \r\n", __func__, __LINE__); \
	dbg_printf(DEBUG_LEVEL_ERROR, __VA_ARGS__); \
